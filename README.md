...
1. Добавить ссылки на файлы
2. На 6-м и 17-м слайдах выделять то, про что говорю.
3. На 11-м слайде дать ссылку на сервер на DO.
4. После страта live-coding: шаблон получился не очень, мы в дальнейшем его модифицируем.
5. В тесты добавить логи.
6. В partialUpdate передавать только часть объекта.
